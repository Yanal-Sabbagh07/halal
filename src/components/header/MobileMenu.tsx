...
const MobileMenu = ({ isOpen, setIsOpen }: IMobileNav) => {
  ...
  return (
    <ul
      className="absolute  min-h-[calc(100vh-64px)] bg-slate-900  right-0 w-full flex flex-col items-center justify-evenly trnsition ease transform duration-300 text-slate-100 text-xl top-16"
      style={{
